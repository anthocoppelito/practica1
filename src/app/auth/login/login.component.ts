...
import {
  ...
  noSpacesValidator,
} from './validatorsLogin/validatorsLogin';
...
export class LoginComponent {
  ...
  login() {
    if (this.loginForm.valid && this.captchaToken) {
      // Valida que los validators sean true
      ...
      if (!this.captchaToken) {
        ...
        this.loginError =
          'Por favor, completa el captcha. Si no lo visualizas, revisa tu conexión a internet.';
      } else {
